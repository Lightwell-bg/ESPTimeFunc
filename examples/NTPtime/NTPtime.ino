...
bool useRTC = false; //Set "true" if use RTC DS3231 (ESP8266 SDA -> D2, SCL ->D1; ESP32 SDA -> D21, SCL ->D22)
...
void setup() {
    ...
    myESPTime.begin(timezone, isDayLightSaving, sNtpServerName, sNtpServerName2, sNtpServerName3);
...
void loop() {
  ...
  if (lastSec != tnow.tm_sec) {
      Serial.print("Ok, NTP Time = "); print2digits(tnow.tm_hour);
